...
import "../Components/Extras/openings/ExtrasMenu.css";
import "./rightbar.css";

const OpeningDetails = ({ itemClass, id, isLocked, onLockChange }) => {
  const {
    openingInstances,
    handleWidth,
    handleHeight,
  ...
  const openingInstance = openingInstances.find(
      ...
      {openingInstance.isOpen && (
        <>
          <span className="extra-headings">
            <p style={{ position: "relative", left: 20 }}>Openings</p>
            <a
              href="javascript:;"
          ...
          {/* Position Y Control */}
          <div className="field-box">
            <span className="inner-headings">Position Y</span>
            <div className="range-box">
              <input
                type="range"
                min={1}
                ...
                onChange={(e) => {
                  ...
                  handlePositionY(openingInstance.id, e.target.value);
                }}
              />
              <input
                type="number"
