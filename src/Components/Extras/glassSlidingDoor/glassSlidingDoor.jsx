...
import './glassSlidingDoor.css'; // Ensure you create and import the CSS file

var loaded_meshes = [];
var id = 0;

export const meshLoaderGlassSlidingDoor = (loadedMeshes) => {
  loaded_meshes = loadedMeshes;
  return loaded_meshes;
}

const GlassSlidingDoorMenu = ({ itemClass }) => {
  ...
  return (
    <div className={`glass-sliding-door-container ${itemClass}`}>
      {doors === true ? <>
        <span className="glass-sliding-door-headings">
          <p>Glass Sliding Door</p>
        ...
        : <>
          <button onClick={() => setDoors(!doors)} className='glass-sliding-door-toggle-button'>
...
export default GlassSlidingDoorMenu;
